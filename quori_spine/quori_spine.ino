...
ros::Publisher pub_MLeftOffset("/quori/waist/motor_offset_status", &lmo3_msg);

geometry_msgs::Vector3 lmg3_msg;
ros::Publisher pub_MLeftGoal("/quori/waist/motor_goal", &lmg3_msg);
...
ros::Subscriber<geometry_msgs::Vector3> sub_leftarmpos("/quori/waist/cmd_pos", CallbackLeftArmPos); //subscriber 
ros::Subscriber<std_msgs::Empty> sub_leftarmsync("/quori/waist/sync_slip", CallbackSyncLeftArmSlip); //
ros::Subscriber<geometry_msgs::Vector3> sub_leftarmPID1("/quori/waist/set_pid1", CallbackLeftArmSetPID1); //subscriber  
ros::Subscriber<geometry_msgs::Vector3> sub_leftarmPID2("/quori/waist/set_pid2", CallbackLeftArmSetPID2); //subscriber 
ros::Subscriber<geometry_msgs::Vector3> sub_leftarmposdir("/quori/waist/cmd_pos_dir", CallbackLeftArmPosDir); //subscriber 
ros::Subscriber<std_msgs::Bool> sub_leftarmoverride("/quori/waist/limit_override", CallbackSyncLeftArmOverride); //
